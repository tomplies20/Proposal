...
def SVD(partial_wave, chiral_order, SVD_order, lamb,  singular_values ):
        ...
        for o in range(SVD_order + 1):
            ...
            V00_new = 0
            file00 = '/Users/pleazy/PycharmProjects/Proposal/phaseshifts_no_interp/potentials/SVD_files/operators/' + "SVD_chiral_order_%s_lambda_%s_SLLJT_%s_SVD_order_%s" % (orders[chiral_order], lamb, partial_wave, o+1)
...
def SVD_fixed_LECs(partial_wave, chiral_order, SVD_order, lamb):
    potential_sum = 0
    sv00 = '/Users/pleazy/PycharmProjects/Proposal/phaseshifts_no_interp/potentials/SVD_files/singular_values/' + "SVD_chiral_order_%s_lambda_%s_SLLJT_%s_singular_values" % (orders[chiral_order], lamb , partial_wave)
    singular_values = np.loadtxt(sv00)
    for o in range(SVD_order + 1):
        sv = singular_values[o]
        # if o in SVD_variation_index:
        V00_new = 0
        file00 = '/Users/pleazy/PycharmProjects/Proposal/phaseshifts_no_interp/potentials/SVD_files/operators/' + "SVD_chiral_order_%s_lambda_%s_SLLJT_%s_SVD_order_%s" % (
        orders[chiral_order], lamb, partial_wave, o + 1)
