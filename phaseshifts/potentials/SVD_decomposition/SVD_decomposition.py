...
for o in range(5):
    ...
    for i in range(len(S)):
        ...
        for l in range(SVD_range):
            ...
            # file_name = "energies"
            f = open('/Users/pleazy/PycharmProjects/pythonProject/SVD/SVD_files/operators/' + file_name, 'w')
            for m in range(100):
        ...
        k = open('/Users/pleazy/PycharmProjects/pythonProject/SVD/SVD_files/singular_values/' + file_name_singular_value, 'w')
