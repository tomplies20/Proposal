...
partial_wave = '10010'
data_ = np.loadtxt(
    f'/Users/pleazy/PycharmProjects/Proposal/phaseshifts_no_interp/random_sampling/phaseshifts_SLLJT_{partial_wave}_lambda_2.00_s5_new_2.dat')
data_ = np.loadtxt(
...
# print(weights)
# print(weights)
f = open('weights_pdf_custom_grid_x.txt', 'w')
# for n in range(len(weights)):
# for i in range(lin_size):
#    for j in range(lin_size):

for n in range(new_data_size):
    f.write(str(all_weights[n]))
    f.write('\n')
weights_ = weights ** 0
